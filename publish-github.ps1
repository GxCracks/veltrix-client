...
Write-Host 'VELTRIX GitHub Pages Publisher 4.7.1' -ForegroundColor Cyan
...
Write-Host 'It can take a few minutes for the first Pages deployment to become live.'
